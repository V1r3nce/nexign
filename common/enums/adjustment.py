...
class AdjustmentUIType(StrEnum):
    negative = "Отрицательная корректировка"
    positive = "Положительная корректировка"


class AdjustmentOption(StrEnum):
    payment = "Ввод корректировки платежа"
    charge = "Ввод корректировки начисления"


class AdjustmentCorrectionType(StrEnum):
    object = "Объект"
    target = "Цель"


class AdjustmentCorrectionObjectType(StrEnum):
    bill = "Счет"
