...
class ClientProfilePage:
    ...
    def fill_client_new_address(self, country: str, region: str, city: str, street: str, building_number: int,
        ...
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Страна")
        ...
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Регион")
        self.create_address_form.OBJECT_NAME_AUTOCOMPLETE.fill(region)
        self.create_address_form.REGION_TYPE_DROPDOWN.click()
        self.create_address_form.choose_option_with_name("Область")
        self.create_address_form.APPLY_BTN.click()

        self.create_address_form.ADD_ADDRESS_OBJECT_BTN.click()
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Город")
        self.create_address_form.OBJECT_NAME_AUTOCOMPLETE.fill(city)
        self.create_address_form.CITY_TYPE_DROPDOWN.click()
        self.create_address_form.choose_option_with_name("Город")
        self.create_address_form.APPLY_BTN.click()

        self.create_address_form.ADD_ADDRESS_OBJECT_BTN.click()
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Улица")
        self.create_address_form.OBJECT_NAME_AUTOCOMPLETE.fill(street)
        self.create_address_form.STREET_TYPE_DROPDOWN.click()
        self.create_address_form.STREET_TYPE_DROPDOWN.fill("Улица")
        self.create_address_form.choose_option_with_name("Улица")
        self.create_address_form.APPLY_BTN.click()

        self.create_address_form.ADD_ADDRESS_OBJECT_BTN.click()
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Дом")
        self.create_address_form.HOUSE_TYPE_DROPDOWN.click()
        self.create_address_form.HOUSE_TYPE_DROPDOWN.fill("Дом")
        self.create_address_form.choose_option_with_name("Дом")
        ...
        self.create_address_form.ADD_ADDRESS_OBJECT_BTN.click()
        self.create_address_form.OBJECT_TYPE.click()
        self.create_address_form.choose_option_with_name("Жилое помещение")
        self.create_address_form.APARTMENT_TYPE_DROPDOWN.click()
        self.create_address_form.choose_option_with_name("Квартира")
