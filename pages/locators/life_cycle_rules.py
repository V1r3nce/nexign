...
class LifeCircleRules(BaseElements):
    ...
    def __init__(self, page: Page):
        ...
        self.GRAPHS_LIST = ElementsList(
            ...
            "Список графов", self.page)
        self.ADD_TRANSITION_BTN = Element("[id*=panel-transitions] button[variant=primary]",
                                          "Кнопка 'Создание перехода'", self.page)
        self.NO_TRANSITIONS_MESSAGE = Element(
            "//*[contains(@id, 'panel-transitions')] //div[1] //div[2] //*[contains(@class, 'platform-empty-box')]",
            "Сообщение 'Переходы правила не найдены'", self.page)
