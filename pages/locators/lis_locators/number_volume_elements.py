...
class NumberVolumeElementsLis(BaseElementsLis):
    ...
    def __init__(self, page: Page):
        ...
        self.ADD_NUMBER_BTN = Element(
            "[ng-click*='dialogs.addNumberDialog.show()']", "Кнопка 'Добавление номера'", self.page
        )
        self.EDIT_NUM_BTN = Element(
            "[ng-click*='dialogs.editNumberDialog.show()']", "Кнопка 'Редактирование номера'", self.page
        )
        self.GROUP_EDIT_BTN = Element(
            "[ng-disabled*='massEditNumbersDisabled'] div ps-button", "Кнопка 'Массовое редактирование'", self.page
        )
        self.GROUP_EDIT_NUM_ATTRIBUTE_BTN = Element(
            "ps-list-item[ng-click*='massEditNumbersAttributes']", "Кнопка 'Редактировать атрибуты номеров'", self.page
        )
        ...
        self.CHANGE_NUM_CLASS_BTN = Element(
            "[ng-click*='massEditNumberClassDialog']", "Кнопка 'Изменить класс номера'", self.page
        )
        self.LINK_DEF_TO_ABC_BTN = Element(
            "[ng-click*='dialogs.linkingNumberDialog']", "Кнопка 'Связывание номеров DEF и ABC'", self.page
        )
        ...
        self.SET_OUT_OF_ISOLATION_BTN = Element("[ng-click*='outOfIsolation']", "Кнопка 'Вывод из карантина'", self.page)
        self.LINK_NUMBER_BTN = Element(
            "[ng-click*='linkingNumberDialog']", "Кнопка 'Связывание номеров DEF и ABC'", self.page
        )
        ...
        self.NUMBERS_COUNTER = Element(
            "div.toolbar-right a.toolbar-quick-filter__item_active", "Счетчик номеров", self.page
        )
        ...
        self.PHONE_NUMBERS_COLOUR = ElementsList(
            "tr.n-grid__row td:nth-child(1)", "Цвета статусов номер телефонов", self.page
        )
        ...
        self.PHONE_NUMBERS_CLASS = ElementsList("tr.n-grid__row td:nth-child(5)", "Классы номеров телефонов", self.page)
        self.PHONE_NUMBERS_STATUS = ElementsList(
            "tr.n-grid__row td:nth-child(6)", "Статусы номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_STATE = ElementsList(
            "tr.n-grid__row td:nth-child(8)", "Состояния номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_BLOCKING = ElementsList(
            "tr.n-grid__row td:nth-child(11)", "Блокировки номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_COMMUTATORS = ElementsList(
            "tr.n-grid__row td:nth-child(12)", "Коммутатор номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_STANDARDS = ElementsList(
            "tr.n-grid__row td:nth-child(13)", "Стандарт номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_OPERATORS = ElementsList(
            "tr.n-grid__row td:nth-child(14)", "Оператор номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_TYPES = ElementsList(
            "tr.n-grid__row td:nth-child(15)", "Тип операции номеров телефонов", self.page
        )
        ...
        self.PHONE_NUMBERS_COMMUTATORS_ABC = ElementsList(
            "tr.n-grid__row td:nth-child(13)", "Коммутатор номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_STANDARDS_ABC = ElementsList(
            "tr.n-grid__row td:nth-child(14)", "Стандарт номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_OPERATORS_ABC = ElementsList(
            "tr.n-grid__row td:nth-child(15)", "Оператор номеров телефонов", self.page
        )
        self.PHONE_NUMBERS_TYPES_ABC = ElementsList(
            "tr.n-grid__row td:nth-child(16)", "Тип операции номеров телефонов", self.page
        )
        self.COMMENTS_ABC = ElementsList("tr.n-grid__row td:nth-child(21)", "Комментарии номеров телефонов", self.page)

        # Модалка История по номеру
        self.REFRESH_HISTORY_BTN = Element("[ng-click*='refreshGrid()']", "Кнопка 'Обновить данные'", self.page)
        self.HISTORY_TYPE_BTN = ElementsList(
            "[ng-click*='historyDialog.setActive']", "Кнопка 'Обновить данные'", self.page
        )
        ...
        self.MSISDN_FILTER_INPUT_TO = Element(
            "[ng-model*='searchParameters.MSISDN.endValue']", "Поле ввода фильтр 'MSISDN' Конечное значение", self.page
        )
        ...
        self.CLASS_FILTER_OPTIONS = ElementsList(
            "//*[@user-value='item.numberClassId']", "Опции фильтр 'Класс'", self.page
        )
        ...
        self.STATUS_OPTION_BUSY = Element(
            "//span[contains(text(), 'Занят')]", "Фильтр 'Статус' опция 'Занят'", self.page
        )
        self.STATUS_OPTION_UNAVAILABLE = Element(
            "//span[contains(text(), 'Недоступен')]", "Фильтр 'Статус' опция 'Недоступен'", self.page
        )
        self.STATUS_OPTION_FREE = Element(
            "//span[contains(text(), 'Свободен')]", "Фильтр 'Статус' опция 'Свободен'", self.page
        )
        ...
        self.STATE_FILTER_OPTIONS = ElementsList(
            "//*[@user-value='item.phoneNumberStateId']", "Опции фильтр 'Состояние'", self.page
        )
        ...
        self.USER_FILTER_FIELD = Element(
            "//div[@class='lis-search-numbers-params__item'][8]//input", "Поле ввода 'Пользователь'", self.page
        )
        ...
        self.FILTER_SEARCH_BTN = Element(".lis-search-numbers-view [ng-click*='search()']", "Кнопка 'Найти'", self.page)
        self.CLEAR_FILTER_BTN = Element(
            ".lis-search-numbers-view [ng-click*='numValueSearchClear()']", "Кнопка 'Очистить фильтры'", self.page
        )

        # Модальное окно Добавление номера
        self.MODAL_ADD_NUMBER = Element(
            "//body/div[contains(@class, 'n-popup')][1]", "Окно 'Добавление номера'", self.page
        )
        self.MODAL_ADD_NUMBER_TITLE = Element(
            "//body/div[contains(@class, 'n-popup')][1]/div[1]/div[1]", "Заголовок окна 'Добавление номера'", self.page
        )
        self.LOAD_NUMBER_BUTTON = Element(
            "//body/div[contains(@class, 'n-popup')][1]//ps-button[@icon='open']", "Кнопка 'Загрузить номера'", self.page
        )
        ...
        self.CHOSEN_CATEGORY_FIELD = Element("[ng-model*='numberCategoryId'] > div > div", "Поле 'Категория'", self.page)
        ...
        self.NUMBER_TYPE_FIELD = Element(
            "[ng-model*='phoneNumberTypeId'] > div > div", "Поле 'Тип нумерации'", self.page
        )
        ...
        self.OPERATOR_OPTIONS = ElementsList(
            "//ps-list-item[contains(@user-value, 'operator.operatorId')]", "Варианты списка 'Оператор'", self.page
        )
        self.AVAILABLE_TO_LINK = Element(
            ".n-popup [ng-model*='phoneNumberTypeLinkId'] > div > div", "Поле 'Доступность для связки'", self.page
        )
        self.USE_GOAL_FIELD = Element(
            "[ng-model*='phoneNumberPurposeId'] > div > div", "Поле 'Цель использования'", self.page
        )
        self.COMMENT_FIELD = Element(".n-popup [ng-model*='note']", "Поле 'Комментарий'", self.page)
        self.NUMBER_TYPE_LINE = ElementsList(
            "//body/div[contains(@class, 'n-popup')][1] //td/..", "Строки таблицы 'Разметка классов'", self.page
        )
        ...
        self.NUMBER_TYPE_CHECKBOXES = ElementsList(
            "//body/div[contains(@class, 'n-popup')][1]//tr/td[1]", "Чекбоксы 'Разметка классов'", self.page
        )
        self.NUMBER_TYPE_ALL_CHECKBOX = Element(
            "//body/div[contains(@class, 'n-popup')][1]//tr/th[1]", "Выбрать все чекбоксы 'Разметка классов'", self.page
        )
        ...
        self.ABC_START_INPUT = Element(
            "[ng-model*='startPhoneNumberABC']", "Поле ввода 'Начальное значение ABC'", self.page
        )
        self.ABC_END_INPUT = Element("[ng-model*='endPhoneNumberABC']", "Поле ввода 'Конечное значение ABC'", self.page)
        self.DEF_START_INPUT = Element(
            "[ng-model*='startPhoneNumberDEF']", "Поле ввода 'Начальное значение ABC'", self.page
        )
        ...
        self.CHOOSE_CLASS_TITLE = Element(
            "//*[contains(@ng-model, 'editNumber.numberClassId')]/../div[1]", "Заголовок 'Класс номера'", self.page
        )
        self.CHOOSE_CLASS_FIELD = SelectLIS(
            "[ng-model*='editNumber.numberClassId'] [ps-link-element='elements.value']", "Поле выбора класса", self.page
        )
        self.CLASS_OPTIONS = ElementsList(
            "ps-list-item[user-value='item.numberClassId']", "Опции выбора класса", self.page
        )
        self.CONFIRM_CHANGE_CLASS_BTN = Element("[on-submit*='updateNumberClass']", "Кнопка 'Сохранить'", self.page)
        self.CANCEL_CHANGE_CLASS_BTN = Element(
            "[ng-click*='massEditNumberClassDialog.close']", "Кнопка 'Отменить'", self.page
        )
        ...
        self.UPDATE_TEMPLATE_BTN = Element(
            "[ng-click*='refreshGrid(model.templates)']", "Кнопка 'Обновить список шаблонов'", self.page
        )

        # TAB Шаблоны классов номеров Таблица шаблонов
        self.TEMPLATE_TABLE_COLUMN_NAMES = ElementsList(
            "[rows='model.templates.rows'] tr.n-grid__head-row th>div", "Названия столбцов таблицы шаблонов", self.page
        )
        self.TEMPLATE_TABLE_LINE = ElementsList(
            "[rows='model.templates.rows'] tr.n-grid__row", "Строки таблицы шаблонов", self.page
        )
        self.TEMPLATE_NAME = ElementsList(
            "[rows='model.templates.rows'] tr.n-grid__row td:nth-child(2)", "Наименование шаблона", self.page
        )
        self.TEMPLATE_CLASS = ElementsList(
            "[rows='model.templates.rows'] tr.n-grid__row td:nth-child(3)", "Класс шаблона", self.page
        )
        self.TEMPLATE_PRIORITY = ElementsList(
            "[rows='model.templates.rows'] tr.n-grid__row td:nth-child(4)", "Приоритет шаблона", self.page
        )
        ...
        self.TEMPLATE_NAME_INPUT = Element(
            "input[ng-model*='addTemplate.values.name']", "Поле ввода 'Наименование шаблона'", self.page
        )
        self.CHOOSE_CLASS_BLOCK_TITLE = Element(
            "//*[contains(@ng-model, 'addTemplate.values.numberClassId')]/../div[1]", "Название поля 'Класс'", self.page
        )
        self.CHOOSE_CLASS_BLOCK = SelectLIS(
            "[ng-model*='addTemplate.values.numberClassId']", "Блок выбора 'Класс'", self.page
        )
        self.TEMPLATE_PRIORITY_INPUT_TITLE = Element(
            "//*[contains(@ng-model, 'addTemplate.values.priority')]/../div[1]", "Название поля 'Приоритет'", self.page
        )
        self.TEMPLATE_PRIORITY_INPUT = Element(
            "input[ng-model*='addTemplate.values.priority']", "Поле ввода 'Приоритет'", self.page
        )
        ...
        self.EDIT_TEMPLATE_NAME_INPUT = Element(
            "input[ng-model*='editTemplate.values.name']", "Поле ввода 'Наименование шаблона'", self.page
        )
        self.EDIT_CHOOSE_CLASS_BLOCK = SelectLIS(
            "[ng-model*='editTemplate.values.numberClass.numberClassId']", "Блок выбора 'Класс'", self.page
        )
        self.EDIT_TEMPLATE_PRIORITY_INPUT = Element(
            "input[ng-model*='editTemplate.values.priority']", "Поле ввода 'Приоритет'", self.page
        )
        ...
        self.RULE_TABLE_LINE = ElementsList(
            "[rows='model.templatesRules.rows'] tr.n-grid__row", "Строки таблицы условий", self.page
        )
        self.RULE_NAME = ElementsList(
            "[rows='model.templatesRules.rows'] tr.n-grid__row td:nth-child(1)", "Наименование условия", self.page
        )
        self.RULE_CONDITION = ElementsList(
            "[rows='model.templatesRules.rows'] tr.n-grid__row td:nth-child(2)", "Условие", self.page
        )
        self.RULE_IS_ACTIVE = ElementsList(
            "[rows='model.templatesRules.rows'] tr.n-grid__row td:nth-child(3)", "Активность условия", self.page
        )
        self.RULE_TEST_NUMBER = ElementsList(
            "[rows='model.templatesRules.rows'] tr.n-grid__row td:nth-child(4)", "Тестовый номер", self.page
        )
        ...
        self.RULE_NAME_INPUT = Element(
            "input[ng-model*='addRules.values.name']", "Поле ввода 'Наименование условия'", self.page
        )
        self.RULE_CONDITION_INPUT_TITLE = Element(
            "//*[contains(@ng-model, 'addRules.values.condition')]/../div[1]", "Название поля 'Условие'", self.page
        )
        self.RULE_CONDITION_INPUT = Element(
            "*[ng-model*='addRules.values.condition']", "Поле ввода 'Условие'", self.page
        )
        self.RULE_TEST_NUMBER_INPUT = Element(
            "input[ng-model*='addRules.values.testMSISDN']", "Поле ввода 'Тестовый номер'", self.page
        )
        self.RULE_IS_ACTIVE_CHECKBOX = Element(
            "[ng-model*='addRules.values.isActive'] span.n-check-checkbox", "Чекбокс 'Активировать условие'", self.page
        )
        ...
        self.EDIT_RULE_NAME_INPUT = Element(
            "input[ng-model*='editRules.values.name']", "Поле ввода 'Наименование условия'", self.page
        )
        self.EDIT_RULE_CONDITION_INPUT = Element(
            "*[ng-model*='editRules.values.condition']", "Поле ввода 'Условие'", self.page
        )
        self.EDIT_RULE_TEST_NUMBER_INPUT = Element(
            "input[ng-model*='editRules.values.testMSISDN']", "Поле ввода 'Тестовый номер'", self.page
        )
        self.EDIT_RULE_IS_ACTIVE_CHECKBOX = Element(
            "[ng-model*='editRules.values.isActive'] span.n-check-checkbox", "Чекбокс 'Активировать условие'", self.page
        )
