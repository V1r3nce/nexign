...
from pages.ui_elements import Element, Select, Radio, MultySelect, ElementsList
...
class SelectProductOffersForm(BaseElements):
    ...
    def __init__(self, page: Page):
        ...
        self.PRODUCT_TYPE = Radio("#productType", "Тип продукта", self.page)
        self.PRODUCT_CATEGORY = Radio("#productOfferingCategoryCodes", "Категория", self.page)
