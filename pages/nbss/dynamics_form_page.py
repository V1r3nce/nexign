...
class DynamicsFormPage(BasePage):
    ...
    def check_product_details_taxes(self, product_offer_name: str) -> None:
        ...
        """
        self.product_offer_form.PRODUCT_CARD_NAME.wait_to_be_visible(timeout=15000)
        product_index = [card_name.text for card_name in self.product_offer_form.PRODUCT_CARD_NAME].index(
            product_offer_name
        )
        ...
        self.product_info_form.CROSS_BTN.wait_to_be_enabled(timeout=15000)
        self.product_info_form.CROSS_BTN.click()
        self.product_info_form.PRODUCT_NAME.not_to_be_visible(timeout=15000)
