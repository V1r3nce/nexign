...
class PaymentsPage(BasePage):
    ...
    def check_from_account_fields(self, account_number: str, user_name: str, account_type: str, chosen_reason: str,
                                  comment: str, account_sum: str, relocate_sum: str, available_after_transfer: str):
    ...
    def check_to_account_fields(self, account_number: str, user_name: str, account_type: str, chosen_reason: str,
                                comment: str, current_balance: str, added_sum: str, final_balance: str):
