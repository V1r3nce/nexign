...
@pytest.fixture
def add_and_remove_class() -> dict:
    """Фикстура для создания и удаления класса номеров"""
    number_classes_api = NumberClassesRequests()
...
@pytest.fixture
def add_and_remove_template(add_and_remove_class: dict) -> dict:
...
@pytest.fixture
def add_and_remove_rule(add_and_remove_template: dict) -> dict:
...
@pytest.fixture
def add_class_and_remove_template(add_and_remove_class: dict) -> dict:
...
@pytest.fixture
def add_template_and_remove_rule(add_and_remove_template: dict) -> dict:
