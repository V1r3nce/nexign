...
@pytest.fixture
def add_and_remove_class(api_request_auth_context):
...
@pytest.fixture
def add_and_remove_template(add_and_remove_class, api_request_auth_context):
    ...
    template_id = number_classes_api.add_number_class_template(name=template_name, number_class_id=class_id,
...
@pytest.fixture
def add_and_remove_rule(add_and_remove_template, api_request_auth_context):
    ...
    rule_id = number_classes_api.add_template_rule(template_id=template_id, name=rule_name,
                                                   condition=":1 = :2", test_MSISDN=9912346745)
...
@pytest.fixture
def add_class_and_remove_template(add_and_remove_class, api_request_auth_context):
...
@pytest.fixture
def add_template_and_remove_rule(add_and_remove_template, api_request_auth_context):
