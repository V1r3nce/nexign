...
class TestSimCardsPreview:
    ...
    def test_sim_card_preview(self, api_request_auth_context: APIRequestContext):
        ...
        self.sim_cards_page.sim_cards_elements.LINE_CHECKBOXES.wait_to_be_visible(3)
    ...
    def test_sim_card_history(self, api_request_auth_context: APIRequestContext):
        ...
        (self.sim_cards_page.sim_cards_elements.TABLE_FIRST_COLUMN_ELEMENTS[0].
         wait_to_have_text(re.compile(r"Занят|Свободен|Недоступен")))
    ...
    @allure.tag("can_auth", "success")
    def test_sim_cards_send_to_seller(self):
        self.home_page_lis.SIM_CARD_BTN.click()
        self.sim_cards_page.sim_cards_elements.PAGE_TABS.wait_to_have_count(3)
        self.sim_cards_page.sim_cards_elements.PAGE_TABS[0].element_have_css_color("color", "dark_grey")
        ...
        self.sim_cards_page.sim_cards_elements.FIRST_BTN[-1].click()
        self.sim_cards_page.sim_cards_elements.SELLER_FIELDS[0].wait_to_have_text(new_seller)
    ...
    @allure.tag("can_auth", "success")
    def test_sim_cards_send_to_seller_without_filter(self):
        self.home_page_lis.SIM_CARD_BTN.click()
        self.sim_cards_page.sim_cards_elements.PAGE_TABS.wait_to_have_count(3)
        self.sim_cards_page.sim_cards_elements.PAGE_TABS[0].element_have_css_color("color", "dark_grey")
        self.sim_cards_page.sim_cards_elements.REFRESH_BTN.click()
        self.sim_cards_page.sim_cards_elements.LINE_CHECKBOXES.wait_to_be_visible(3)
        self.sim_cards_page.find_useful_line_free_not_linked_not_blocked()
    ...
    @allure.tag("can_auth", "success")
    def test_sim_cards_change_commutator(self):
        self.home_page_lis.SIM_CARD_BTN.click()
        self.sim_cards_page.sim_cards_elements.PAGE_TABS.wait_to_have_count(3)
        self.sim_cards_page.sim_cards_elements.PAGE_TABS[0].element_have_css_color("color", "dark_grey")
    ...
    @allure.tag("can_auth", "success")
    def test_sim_cards_filters(self, api_request_auth_context: APIRequestContext):
        self.home_page_lis.SIM_CARD_BTN.click()
        self.sim_cards_page.sim_cards_elements.PAGE_TABS.wait_to_have_count(3)
        self.sim_cards_page.sim_cards_elements.PAGE_TABS[0].element_have_css_color("color", "dark_grey")
        self.sim_cards_page.sim_cards_elements.SEARCH_BTN.click()
        ...
        self.sim_cards_page.sim_cards_elements.IMSI_FILTER_OPTIONS.to_have_text_list(["По диапазону", "По количеству",
                                                                                      "Точное значение", "Из файла"])
        self.sim_cards_page.sim_cards_elements.IMSI_FILTER_BTN.click()
        self.sim_cards_page.sim_cards_elements.ICC_FILTER_BTN.click()
        self.sim_cards_page.sim_cards_elements.ICC_FILTER_OPTIONS.to_have_text_list(["По диапазону", "По количеству",
                                                                                     "Точное значение", "Из файла"])
        self.sim_cards_page.sim_cards_elements.ICC_FILTER_BTN.click()
        self.sim_cards_page.sim_cards_elements.MSISDN_FILTER_BTN.click()
        self.sim_cards_page.sim_cards_elements.MSISDN_FILTER_OPTIONS.to_have_text_list(["По диапазону", "По количеству",
                                                                                        "Точное значение", "Из файла"])
    ...
    @allure.tag("can_auth", "success")
    def test_sim_cards_templates(self, api_request_auth_context: APIRequestContext, remove_sim_card_search_templates):
        self.home_page_lis.SIM_CARD_BTN.click()
        self.sim_cards_page.sim_cards_elements.PAGE_TABS.wait_to_have_count(3)
        self.sim_cards_page.sim_cards_elements.PAGE_TABS[0].element_have_css_color("color", "dark_grey")
        delay(.3, reason="Кнопка не активна доли секунды, даже в случае enabled")
        ...
        (self.sim_cards_page.sim_cards_elements.MODAL_BODY_TEXT[0].
         to_contain_text("Вы действительно хотите удалить шаблон?"))
        self.sim_cards_page.sim_cards_elements.FIRST_BTN[-1].click()
        self.sim_cards_page.sim_cards_elements.CHOOSE_SEARCH_TEMPLATE_BTN.click()
