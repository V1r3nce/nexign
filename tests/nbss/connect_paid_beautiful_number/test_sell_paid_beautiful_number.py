...
class TestSellPaidBeautifulNumber:
    ...
    def test_connect_beautiful_number_b2b(self, base_url: str, create_organization: OrganizationClient) -> None:
        ...
        self.personal_account_page.locators.PRODUCTS_CONSUMPTION_DETAILS_BTN.wait_to_be_visible()
        self.personal_account_page.locators.PRODUCTS_CONSUMPTION_DETAILS_BTN.click(force=True)
