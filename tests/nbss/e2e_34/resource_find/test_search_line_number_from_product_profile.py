...
class TestSearchProductProfileByLineNumber:
    ...
    @allure.title("07. Поиск ресурсов по продуктовому профилю (номер линии)")
    @allure.id(637235)
    def test_search_resources_by_product_profile_line_number(
