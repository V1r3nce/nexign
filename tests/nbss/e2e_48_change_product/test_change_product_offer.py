...
class TestChangeProductOfferContract:
    ...
    def test_change_product_offer_with_price_manual(self, organization_user_data) -> None:
        ...
        name_product = self.client_product_profile.change_product_offer_with_contract(auto_contract=False)
    ...
    def test_change_offer_with_nomenclature(self, organization_user_data) -> None:
        ...
        name_product = self.client_product_profile.change_product_offer_with_contract(
            auto_contract=True, product_number=3
        )
    ...
    def test_change_offer_without_permission(self, organization_user_data) -> None:
        ...
        self.client_product_profile.locators.PRODUCTS_OPTIONS_OPEN_BTN[0].wait_to_be_enabled()
        self.client_product_profile.locators.PRODUCTS_OPTIONS_OPEN_BTN[0].click()
        self.client_product_profile.locators.LOAD_SPINS.not_to_be_visible(timeout=8000)
        self.client_product_profile.locators.PRODUCTS_OPTIONS_CHANGE_MAIN_RODUCT_BTN.not_to_be_enabled()
    ...
    def test_change_offer_already_application(self, organization_user_data) -> None:
        ...
        self.client_product_profile.locators.PRODUCTS_OPTIONS_OPEN_BTN[0].click()
        self.client_product_profile.locators.LOAD_SPINS.not_to_be_visible(timeout=8000)
        self.client_product_profile.locators.PRODUCTS_OPTIONS_CHANGE_MAIN_RODUCT_BTN.not_to_be_visible()
    ...
    def test_change_offer_without_other_products(self, organization_user_data) -> None:
        ...
        with allure.step("Инициировать смену продукта"):
            self.client_product_profile.locators.PRODUCTS_STATUS_COLOR.to_have_css_color("background-color", "green")
            self.client_product_profile.locators.SUBSCRIBERS_DETAILS_OPEN_BTN[0].wait_to_be_enabled(timeout=20000)
            self.client_product_profile.locators.SUBSCRIBERS_DETAILS_OPEN_BTN[0].click()
            self.client_product_profile.locators.LOAD_SPINS.not_to_be_visible(timeout=8000)
            self.client_product_profile.locators.PRODUCTS_OPTIONS_CHANGE_MAIN_RODUCT_BTN.click()
