...
class TestInquirySpdContext(InquiryContextBase):
    topic = SettlementServiceTopic.ProvisionOfSettlementDocuments

    @allure.title("25. Предоставление Расчетно-платежных документов (РПД) (уточнение контекста ЛС)")
    @allure.id(859576)
    ...
    @allure.title("26. Предоставление Расчетно-платежных документов (РПД) (без изменения контекста ЛС)")
    @allure.id(859577)
    ...
    @allure.title("27. Предоставление Расчетно-платежных документов (РПД) (с изменением контекста ЛС)")
    @allure.id(859578)
    ...
    @allure.title(
        "28. Предоставление Расчетно-платежных документов (РПД) (переоткрытие формы после изменения контекста ЛС)"
    )
    @allure.id(859579)
