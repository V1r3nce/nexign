...
class TestSale:
    ...
    @allure.id(656649)
    def test_b2b_renewal_inquiry_creation(
        self,
    ...
    @allure.id(656656)
    def test_b2b_move_inquiry_to_current_account(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
        ...
        with allure.step("Переход в раздел Проудкты и проверка данных после смены ЛС"):
            ...
            self.client_profile_elements.PRODUCTS_PERSONAL_ACCOUNT_NUM.to_contain_text(
                test_context.client.agreements[0].accounts[0].number
            )
            self.client_profile_elements.PRODUCT_NAME.to_contain_text(
    ...
    @pytest.mark.skip(reason="https://jira.nexign.com/browse/RMBSS-10854")
    @allure.id(656657)
    def test_b2b_move_account_to_current_client(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
    ...
    @pytest.mark.skip(reason="https://jira.nexign.com/browse/RMBSS-10854")
    @allure.id(656658)
    def test_b2b_move_to_another_client(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
    ...
    @allure.id(656659)
    def test_b2b_additional_inquiry_move(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
        ...
        with allure.step("Проверить корректность изменений после переноса продукта"):
            ...
            with allure.step("Проверить поле 'Продукт' у первого ПП"):
                self.client_profile_elements.PRODUCT_NAME[0].to_contain_text(
            ...
            with allure.step("Проверить Лицевой Счёт ПП"):
                self.client_profile_elements.PRODUCTS_PERSONAL_ACCOUNT_NUM[0].to_contain_text(
                    test_context.client.agreements[0].accounts[0].number
                )
    ...
    @allure.id(656660)
    def test_b2b_main_inquiry_move(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
    ...
    @allure.id(656663)
    def test_b2b_few_inquiries_move(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
        ...
        with allure.step("Проверить корректность изменений после переноса продукта"):
            ...
            with allure.step("Проверить поле абонент у второго ПП"):
                self.client_profile_elements.SUBSCRIBER[1].to_contain_text(
            ...
            with allure.step("Проверить договор второго ПП"):
                self.client_profile_elements.PRODUCTS_CONTRACT_NUM[2].to_contain_text(
    ...
    @allure.id(656664)
    def test_b2b_combine_inquiries_to_account(
        self,
        create_organization: OrganizationClient,
        base_url: str,
    ) -> None:
    ...
    @allure.id(659969)
    def test_b2b_move_inquiries_from_different_accounts_to_another_client(
        self,
        base_url: str,
    ) -> None:
        ...
        with allure.step("Проверить корректность изменений после переноса продукта"):
            ...
            self.client_profile_elements.PRODUCTS_UPDATE_BTN.wait_to_be_visible()
            self.personal_account_page.refresh_page(wait="load")
            self.client_profile_elements.NO_SUBSCRIBERS_BLOCK.wait_to_be_visible()
            self.personal_account_page.open(
            ...
            with allure.step("Проверить поле Абонент для второго ПП"):
                self.client_profile_elements.SUBSCRIBER.wait_to_have_count(2, timeout=15000)
                self.client_profile_elements.SUBSCRIBER[1].to_contain_text(
