...
class TestSaleSamIntegration:
    ...
    def setup(self, nexign_ui_stand_login, api_request_context, create_organization, create_oms_db_connection):
        self.client_inquiry_api = ClientInquiriesRequests(api_request_context)
