...
from db.requests.db_requests import BillingDBRequests
from pages.nbss.finances.discounts_and_charges_settings_page import DiscountsAndChargesSettingsPage
...
class TestEditBillingDiscount:
    ...
    def setup(
        ...
        nexign_stand_login,
        create_organization,
        create_billing_connection: BillingDBRequests,
    ) -> None:
        ...
        self.udb: BillingDBRequests = create_billing_connection
