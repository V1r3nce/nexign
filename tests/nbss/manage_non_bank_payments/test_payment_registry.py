...
class TestManageNonBankPayments:
    ...
    def test_check_non_bank_payment_preview_in_client_payments(
        ...
        self.payment_details_elements.PAYMENT_TYPE_BTN[0].element_have_css_color("background-color", "deep_blue")
        ...
        self.payment_details_elements.PAYMENT_TYPE_BTN[1].element_have_css_color("background-color", "deep_blue")
        self.payment_details_elements.PAYMENT_DATE_FIELDS.wait_not_to_be_visible()
