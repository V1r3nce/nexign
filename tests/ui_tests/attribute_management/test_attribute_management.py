...
class TestAttributeManagement:
    ...
    def test_edit_applied_attribute(
        ...
        self.attribute_locators.NAMES[0].type(self.attribute.name)
        self.attribute_locators.NAMES[1].type(self.attribute.name)
    ...
    def test_edit_attribute(self, base_url, delete_additional_attributes: list):
        ...
        self.attribute_locators.EDIT_BUTTON.click()
        delete_additional_attributes.append(self.attribute)
        self.attribute_locators.NAMES.wait_to_be_visible()
        self.attribute_locators.NAMES[0].fill(self.attribute.name)
        self.attribute_locators.NAMES[1].fill(self.attribute.name)
        self.attribute_locators.APPLY_EDIT_BUTTON.click()
    ...
    def test_mandatory_params_add_attribute(self):
        ...
        self.attribute_locators.NAME_FILL_ERROR.wait_to_have_count(3)
