...
class TestErrorUndoingNotLastBilling:
    ...
    @allure.id(577552)
    @allure.description(
        "Появление диалогового окна с сообщением об ошибке при попытке отката биллинга, не являющегося последним проведенным на данном лицевом счете."
    )
    ...
    @pytest.mark.regress
    def test_error_undoing_not_last_billing(
