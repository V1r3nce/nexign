...
class TestSetBillingDiscount:
    ...
    @allure.id(599270)
    def test_set_billing_discount(self, create_individual_user: IndividualClient, base_url) -> None:
    ...
    @allure.id(676406)
    def test_set_billing_discount_same_id(self, create_individual_user: IndividualClient, base_url) -> None:
        individual_user = create_individual_user
        discount_amount = "50"
        priority = "1"
    ...
    @allure.id(676405)
    def test_edit_billing_discount(self, create_individual_user: IndividualClient, base_url) -> None:
        individual_user = create_individual_user
        discount_amount = "50"
        priority = "1"
