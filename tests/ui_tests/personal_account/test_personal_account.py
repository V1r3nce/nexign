...
from pages.locators.dynamic_form_elements import IndividualCustomerCreate, CreateOrganization, CreateEntrepreneur, \
    AddRelatedPersonForms, PersonalAccountForm
...
class TestPersonalAccount:
    ...
    @allure.id(581810)
    def test_create_personal_account_postpaid_individual(self):
        self.personal_account_page.create_customer_with_type("individual")
        self.personal_account_page.dynamic_form.SAVE_BTN.click()
        self.personal_account_page.notifications.SUCCESS_CREATE_CLIENT.wait_to_be_visible()
    ...
    @allure.id(486084)
    def test_create_personal_account_prepaid_entrepreneur(self):
    ...
    @allure.id(486085)
    def test_create_personal_account_postpaid_entrepreneur(self):
        self.personal_account_page.create_customer_with_type("entrepreneur")
        self.personal_account_page.dynamic_form.SAVE_BTN.click()
        self.personal_account_page.notifications.SUCCESS_NOTIFICATIONS_CLOSE_BTN.click()
        self.personal_account_page.locators.CREATE_AGREEMENT_BTN.click()
    ...
    @allure.id(486086)
    def test_create_personal_account_prepaid_organization(self):
    ...
    @allure.id(486087)
    def test_create_personal_account_postpaid_organization(self):
        self.personal_account_page.create_customer_with_type("organization")
        self.personal_account_page.dynamic_form.SAVE_BTN.click()
        self.personal_account_page.notifications.SUCCESS_CREATE_CLIENT.wait_to_be_visible()
